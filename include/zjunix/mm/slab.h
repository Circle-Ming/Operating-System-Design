...
extern void init_kmem_cpu(struct kmem_cache_cpu *kcpu);
extern void init_kmem_node(struct kmem_cache_node *knode);
extern void init_slab();
extern void init_each_slab(struct kmem_cache *cache, unsigned int size);
extern void slab_free(struct kmem_cache *cache, void *object);
extern unsigned int get_slab(unsigned int size);
extern void *slab_alloc(struct kmem_cache *cache);
extern void format_slabpage(struct kmem_cache *cache, struct page *page);
